...
public class MicrosoftAccessControlItemTask extends AsyncTask<String, Void, AccessControlItem> {
    ...
    protected void onPostExecute(AccessControlItem result) {
        ...
        if (result != null) {
            ...
            editor.putString(res.getString(R.string.pref_translator_access_item_token_type), result.getToken_type());
            editor.putString(res.getString(R.string.pref_translator_access_item_access_token), result.getAccess_token());
            editor.putInt(res.getString(R.string.pref_translator_access_item_expires_in), Integer.valueOf(result.getExpires_in()));
            editor.putString(res.getString(R.string.pref_translator_access_item_scope), result.getScope());
    ...
    private static AccessControlItem getAccessControlItem(String clientId, String clientSecret) throws Exception {
        ...
        // Connection
        final String TOKEN_URL = App.getContext().getResources().getString(R.string.microsoft_translator_token_url);
        ...
        try {
            if (con.getResponseCode() != RESPONSE_CODE_OKAY) {
                ...
                SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
                SharedPreferences.Editor editor = prefs.edit();
                editor.putString(res.getString(R.string.pref_translator_access_item_token_type), null);
                editor.putString(res.getString(R.string.pref_translator_access_item_access_token), null);
                editor.putString(res.getString(R.string.pref_translator_access_item_expires_in), null);
                editor.putString(res.getString(R.string.pref_translator_access_item_scope), null);

...
public class LymboWebUploadTask extends AsyncTask<String, Void, String> {
    ...
    public LymboWebUploadTask() {
    }

    public LymboWebUploadTask(OnCompleteListener ocListener) {
    ...
    private static String uploadLymbo(String accessToken, String id, String author, String content) throws Exception {
        ...
        ph.add(new Param(PARAM_CONTENT, URLEncoder.encode(content, ENCODING)));

        // Connection
        final String UPLOAD_URL = App.getContext().getResources().getString(R.string.lymbo_upload_url);
        HttpURLConnection con = (HttpURLConnection) new URL(UPLOAD_URL).openConnection();
    ...
    public interface OnCompleteListener {
        void onLymboUploaded(String response);
    }
}

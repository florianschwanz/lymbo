 ...
 */
public class ComponentsListView extends ListView {
    ...
    public ComponentsListView(Context context) {
        super(context);
        init(context);
    }

    public ComponentsListView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context);
    }

    public ComponentsListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    ...
    private void updateNeighborViewsForID(long itemID) {
        ...
        ComponentsListAdapter adapter = ((ComponentsListAdapter) getAdapter());
    ...
    private void handleCellSwitch() {
        ...
        if (isBelow || isAbove) {
            ...
            swapElements(components, originalItem, getPositionForView(switchView));
